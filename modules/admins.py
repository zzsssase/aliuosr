...
» `رفع مشرف` **لرفع السخص مشرف في المجموعة**
» **الاستخدام **بالرد على رسالته او يوز الشخص**.

» ` تنزيل مشرف`  **لتنزيل الشخص من الاشراف في المجموعة يجيب يكون انت من قام برفعه**
» **الاستخدام** بالرد على رسالته او يوز الشخص**.

» `حظر` **لحظر الشخص من المجموعة يجب ان تكون مشرف**
» **الاستخدام** بالرد على رسالته او يوز الشخص لحظره**..

» `الغاء حظر` **لرفع الحظر عن الشخص في المجموعة**
» **الاستخدام** بالرد على رسالته او يوز الشخص لالغاء حظره**.
» `طرد` **لطرد الشخص من المجموعة يجب ان تكون مشرف**
» **الاستخدام** بالرد على رسالته او يوز الشخص لطره من المجموعة**.
» `تثبيت` ** لتثبيت رسالة في المجموعة**
» **الاستخدام** بالرد على الرسالة التي تريد تثبيتها**.

» `الغاء التثبيت` **لألغاء تثبيت الرساله في المجموعة**
» **الاستخدام**بالرد على  الرسالة التي تريد الغاء تثبيتها**.

» `مسح` **لمسح الرسالة من المجموعة او الخاص*
» **الاستخدام**بالرد على الرسالة التي مسحها**.

»  `حذف` **لحذف رسالة الشخص في المجموعة يجب ان تكون مشرف**
» **الاستخدام** بالرد على رسالة الشخص الي تريد حذفها**.

» `تنظيف` **لمسح الرسايل في المجموعة يجب ان تكون مشرف**
» **الاستخدام** تنظيف + عدد الرسايل الي تريد مسحها من المجموعة**.

» `وضع صور` **وضع صور للمجموعة يجب ان تكون مشرف**
» **الاستخدام** بالرد على الصوره الي تريد تعملها للمجموعة بي وضع صور.

»  `حذف الصوره` **لحذف صورة المجموعة يجب ان تكون مشرف**
» **الاستخدام** قم بإرسال امر حذف الصوره في المجموعة.

»  `غادر` ** لمغادره من المجموعه**
» **الاستخدام** قم بكتابة الامر دخل المجموعة التي تريد الخروج منها**.
"""
...
@ayra_cmd(pattern="تثبيت$", manager=True, require="pin_messages", fullsudo=True)
async def pin(msg):
    if not msg.is_reply:
...
@ayra_cmd(pattern="مسح( (.*)|$)", manager=True, require="delete_messages")
...
@ayra_cmd(pattern="غادر", fullsudo=False)
async def leave(ayra):
    await ayra.eor(f"`مع السلامة جاري المغادرة من المجموعة!!.`")
